...
public class SubBlock {
	...
	public int[][] getPredict(int intra_bmode, boolean left) {
		...
		if(predict!=null)
			...
			if((intra_bmode == Globals.B_DC_PRED || intra_bmode == Globals.B_VE_PRED || intra_bmode == Globals.B_VR_PRED || intra_bmode == Globals.B_RD_PRED || intra_bmode == Globals.B_HD_PRED)&& left)
	...
	public void predict(VP8Frame frame) {
		...
		//for above left if left and above is null use left (129?) else use above (127?)
		int al;
