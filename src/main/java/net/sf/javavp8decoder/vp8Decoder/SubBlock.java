...
public class SubBlock {
    ...
    public int[][] getPredict(int intra_bmode, boolean left) {
        ...
        if (predict != null)
            ...
            if ((intra_bmode == Globals.B_TM_PRED || intra_bmode == Globals.B_DC_PRED || intra_bmode == Globals.B_VE_PRED
                 || intra_bmode == Globals.B_HE_PRED || intra_bmode == Globals.B_VR_PRED || intra_bmode == Globals.B_RD_PRED
