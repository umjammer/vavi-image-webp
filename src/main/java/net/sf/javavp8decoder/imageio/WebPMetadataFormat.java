...
public class WebPMetadataFormat extends IIOMetadataFormatImpl {
    ...
    private static final WebPMetadataFormat defaultInstance = new WebPMetadataFormat();
    ...
    private WebPMetadataFormat() {
        ...
        super("net.sf.javavp8decoder.imageio.WebPMetadata_0.1", CHILD_POLICY_REPEAT);

        // Set up the "KeywordValuePair" node, which has no children
        addElement("KeywordValuePair", "net.sf.javavp8decoder.imageio.WebPMetadata_0.1", CHILD_POLICY_EMPTY);
